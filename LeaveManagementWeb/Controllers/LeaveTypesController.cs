...
namespace LeaveManagementWeb.Controllers
{
    ...
    {
        private readonly ILeaveTypesRepository leaveTypesRepository;
        ...
        {
            var leaveType = mapper.Map<List<LeaveTypeVM>>(await leaveTypesRepository.GetAllAsync());
        ...
        public async Task<IActionResult> Edit(int id, LeaveTypeVM leaveTypeVM)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if ( !await leaveTypesRepository.Exsits(leaveTypeVM.Id))
                    {
                        return NotFound();
                    }
                    else
